...
describe("release notes", () => {
  ...
  test("renders concise asset guidance, exact source digest, and no adjacent release", () => {
    ...
    expect(notes).not.toContain("## Verify the download");
    expect(notes).not.toContain("SHA256SUMS");
    expect(notes).not.toContain("gh attestation verify");
