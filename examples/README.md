...
| Guide | [A global macOS voice shortcut](macos-voice-shortcut.md) | Power user | macOS |
...
For a global keyboard shortcut that dictates to an exact saved alias, copies the
full answer, and speaks a short version, follow the
